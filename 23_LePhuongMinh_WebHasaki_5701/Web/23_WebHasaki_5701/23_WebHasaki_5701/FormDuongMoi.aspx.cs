...
{
    public partial class FormDuongMoi : System.Web.UI.Page
    {
        ...
        protected void dlst_DM_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (e.CommandName == "Mua")
            {
                ...
                int sl = int.Parse(((TextBox)dlst_DM.Items[e.Item.ItemIndex].FindControl("txtSL")).Text.Trim());
                float tt = giaban*sl;
