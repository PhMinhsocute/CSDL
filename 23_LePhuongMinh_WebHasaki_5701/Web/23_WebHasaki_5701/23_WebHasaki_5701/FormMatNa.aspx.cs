...
{
    public partial class FormMatNa : System.Web.UI.Page
    {
        ...
        protected void dlst_MN_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (e.CommandName == "Mua")
            {
                ...
                int sl = int.Parse(((TextBox)dlst_MN.Items[e.Item.ItemIndex].FindControl("txtSL")).Text.Trim());
                float tt = giaban * sl;
