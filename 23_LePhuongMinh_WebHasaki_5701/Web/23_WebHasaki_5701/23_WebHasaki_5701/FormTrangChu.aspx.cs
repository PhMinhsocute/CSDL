...
{
    public partial class FormTrangChu : System.Web.UI.Page
    {
        ...
        protected void dlst_newsp_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (e.CommandName == "Mua")
            {
                ...
                int sl = int.Parse(((TextBox)dlst_newsp.Items[e.Item.ItemIndex].FindControl("txtSL")).Text.Trim());
                float tt = giaban * sl;
        ...
        protected void dlst_banchay_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (e.CommandName == "Mua")
            {
                string masp = ((Label)e.Item.FindControl("MaSPLabel")).Text;
                ...
                string dvt = ((Label)e.Item.FindControl("DVTLabel")).Text;
                float giaban = float.Parse(((Label)e.Item.FindControl("GiaBanLabel")).Text);
                int sl = int.Parse(((TextBox)dlst_banchay.Items[e.Item.ItemIndex].FindControl("txtSL")).Text.Trim());
                float tt = giaban * sl;
                string hinh = ((Image)e.Item.FindControl("Image")).ImageUrl;
