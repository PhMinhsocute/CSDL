...
{
    public partial class FormToner : System.Web.UI.Page
    {
        ...
        protected void dlst_NCC_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (e.CommandName == "Mua")
            {
                ...
                int sl = int.Parse(((TextBox)dlst_NCC.Items[e.Item.ItemIndex].FindControl("txtSL")).Text.Trim());
                float tt = giaban * sl;
