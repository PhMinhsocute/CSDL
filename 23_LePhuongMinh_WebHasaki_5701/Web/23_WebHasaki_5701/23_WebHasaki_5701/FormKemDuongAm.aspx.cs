...
{
    public partial class FormKemDuongAm : System.Web.UI.Page
    {
        ...
        protected void dlst_KDA_ItemCommand(object source, DataListCommandEventArgs e)
        {
            if (e.CommandName == "Mua")
            {
                ...
                int sl = int.Parse(((TextBox)dlst_KDA.Items[e.Item.ItemIndex].FindControl("txtSL")).Text.Trim());
                float tt = giaban * sl;
